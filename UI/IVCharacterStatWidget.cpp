...
void UIVCharacterStatWidget::NativeConstruct()
{
	Super::NativeConstruct();

	for (TFieldIterator<FNumericProperty> PropIt(FIVCharacterStat::StaticStruct()); PropIt; ++PropIt)
	{
...
void UIVCharacterStatWidget::UpdateStat(const FIVCharacterStat& BaseStat, const FIVCharacterStat& ModifierStat)
{
	for (TFieldIterator<FNumericProperty> PropIt(FIVCharacterStat::StaticStruct()); PropIt; ++PropIt)
	{
		const FName PropKey(PropIt->GetName());
